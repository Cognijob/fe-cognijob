  ...
  const cards = [
    {
      ...
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#1E42AC" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>
      )
    },
    {
      num: '02',
      ...
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#6B5BAE" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
      )
    },
    {
      num: '03',
      ...
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#D94A8C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>
      )
    }
  ]

  return (
    <section id="cara-kerja" className="w-full max-w-[1280px] mx-auto px-16 py-20" style={{ fontFamily: 'Poppins' }}>
